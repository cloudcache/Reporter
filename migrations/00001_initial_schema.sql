...
DROP TABLE call_analyses;
DROP TABLE offline_analysis_jobs;
DROP TABLE realtime_assist_sessions;
DROP TABLE model_providers;
DROP TABLE recordings;
DROP TABLE call_sessions;
DROP TABLE recording_configs;
DROP TABLE storage_configs;
DROP TABLE sip_endpoints;
DROP TABLE agent_seats;
DROP TABLE report_queries;
DROP TABLE report_query_results;
DROP TABLE report_widgets;
DROP TABLE report_versions;
DROP TABLE reports;
DROP TABLE followup_tasks;
DROP TABLE followup_plans;
DROP TABLE data_source_bindings;
DROP TABLE data_source_credentials;
DROP TABLE data_sources;
DROP TABLE submission_events;
DROP TABLE form_submissions;
DROP TABLE form_components;
DROP TABLE form_library_items;
DROP TABLE form_versions;
DROP TABLE forms;
DROP TABLE dictionaries;
DROP TABLE departments;
DROP TABLE medical_records;
DROP TABLE clinical_visits;
